...
The detailed documentation of `kubectl autoscale` can be found [here](/docs/user-guide/kubectl/{{< param "version" >}}/#autoscale).
...
* kubectl autoscale command: [kubectl autoscale](/docs/user-guide/kubectl/{{< param "version" >}}/#autoscale).
