...
{{< code language="yaml" file="mysql-statefulset.yaml" ghlink="/docs/tasks/run-application/mysql-statefulset.yaml" >}}
...
[drain](/docs/user-guide/kubectl/{{< param "version" >}}/#drain).
