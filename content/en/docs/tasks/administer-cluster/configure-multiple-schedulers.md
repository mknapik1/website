...
{{< code language="yaml" file="my-scheduler.yaml" ghlink="/docs/tasks/administer-cluster/my-scheduler.yaml" >}}
...
- Pod spec without any scheduler name
  ...
  {{< code language="yaml" file="pod1.yaml" ghlink="/docs/tasks/administer-cluster/pod1.yaml" >}}
...
- Pod spec with `default-scheduler`
  ...
  {{< code language="yaml" file="pod2.yaml" ghlink="/docs/tasks/administer-cluster/pod2.yaml" >}}
...
- Pod spec with `my-scheduler`
  ...
  {{< code language="yaml" file="pod3.yaml" ghlink="/docs/tasks/administer-cluster/pod3.yaml" >}}
